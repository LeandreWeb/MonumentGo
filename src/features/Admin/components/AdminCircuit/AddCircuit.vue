...
<template>
  <main class="col" id="add-circuit">

    <a href="#" class="title" data-bs-toggle="collapse" data-bs-target="#collapse-add-circuit"
    ...
    <div id="collapse-add-circuit" :class="{ 'collapse show': isCollapsed.value, 'collapse': !isCollapsed.value }">
      ...
      <div class="circuit-infos">
        <div class="d-flex flex-column flex-wrap flex-md-row justify-content-between px-2">
          <label for="name" class="col-md-6 m-1">
            ...
            <input type="text" name="name" id="name" placeholder="Circuit du Vieux-Port" class="form-control text-input">
          </label>
          <label for="qty-poi" class="col-md-2 m-1">
            <h5>Nombre d'arrêts</h5>
            <input type="text" name="qty-poi" id="qty-poi" disabled class="form-control">
          </label>
          <label for="length" class="col-md-3 m-1">
            <h5>Longueur du circuit (km)</h5>
            <input type="text" name="length" id="length" disabled class="form-control">
          </label>
        </div>
      </div>
      <br>
      ...
      <div class="circuit-description">
        ...
        <div class="d-flex flex-column flex-wrap flex-md-row justify-content-between px-2">
          ...
          <textarea name="description" id="description" cols="30" rows="4" placeholder="Description du circuit"
        ...
        <div class="d-flex flex-column flex-wrap flex-md-row justify-content-between px-2 mb-4">
          ...
          <label for="monuments" class="col-md-12 m-1">
            <select name="monuments" id="monuments" class="form-select text-input">
              <option value="1">Sélectionner un monument</option>
              <!-- <option v-for="monument, index of itemStore.getItems" :key="index" :value="monument.sku">
                  {{ monument.name }}
                </option> -->
            </select>
          </label>
      ...
      <hr>
      <div class="text-end">
        <button class="btn btn-success add-circuit-btn">
          Ajouter Circuit
        </button>
      </div>
